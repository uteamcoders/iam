...
sed -i -e "s|###OHS_PASSWORD###|$OHS_PASSWORD|g" "$1"
sed -i -e "s|###OHS_LISTEN_PORT###|$OHS_LISTEN_PORT|g" "$1"
sed -i -e "s|###OHS_SSL_PORT###|$OHS_SSL_PORT|g" "$1"
sed -i -e "s|###OHS_COMPONENT_NAME###|$OHS_COMPONENT_NAME|g" "$1"
sed -i -e "s|###$OHS_DOMAIN_NAME###|$OHS_DOMAIN_NAME|g" "$1"
